...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const newRevision = await QuotationRevision.create({
    ...
    additionalItems: sourceRevision.additionalItems || [],
    ...
    additionalItemsSubtotal: sourceRevision.additionalItemsSubtotal || 0,
    additionalItemsGst: sourceRevision.additionalItemsGst || 0,
    additionalItemsTotal: sourceRevision.additionalItemsTotal || 0,
