...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  await QuotationRevision.create({
    ...
    additionalItems: sourceRev?.additionalItems ?? [],
    ...
    additionalItemsSubtotal: sourceRev?.additionalItemsSubtotal ?? 0,
    additionalItemsGst: sourceRev?.additionalItemsGst ?? 0,
    additionalItemsTotal: sourceRev?.additionalItemsTotal ?? 0,
