        ...
        <div className="bg-card border border-base rounded-2xl p-4 shadow-sm">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-3 mb-4">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-xl bg-amber-50 text-amber-600 dark:bg-amber-900/25 dark:text-amber-300 flex items-center justify-center">
                <Wallet className="w-5 h-5" />
              </div>
              <div>
                <h2 className="text-base font-semibold text-default">Advance Payments</h2>
                <p className="text-sm text-faint">Client-level balances, available advance, and applied history for FY {fy}.</p>
              </div>
            </div>
            <div className="grid grid-cols-3 gap-2 min-w-0 lg:min-w-[420px]">
              <div className="rounded-xl border border-base bg-surface px-3 py-2">
                <p className="text-[11px] text-faint">Available</p>
                <p className="text-sm font-bold text-amber-600 dark:text-amber-400">{formatCurrency(billingSummary.totalAdvance)}</p>
              </div>
              <div className="rounded-xl border border-base bg-surface px-3 py-2">
                <p className="text-[11px] text-faint">Applied this FY</p>
                <p className="text-sm font-bold text-default">{formatCurrency(appliedAdvanceTotal)}</p>
              </div>
              <div className="rounded-xl border border-base bg-surface px-3 py-2">
                <p className="text-[11px] text-faint">Clients</p>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            <div className="flex items-center gap-2 flex-1 rounded-xl border border-base bg-surface px-3 py-2">
              ...
              <input
                className="bg-transparent border-0 ring-0 outline-none flex-1 text-sm text-default placeholder:text-faint"
                placeholder="Search advances by client, ID, mode, reference, or notes..."
                value={search}
            ...
            <button type="button" className="btn-primary justify-center" onClick={onRecordAdvance}>
